...
/**
 * Main application class providing a pure console-based user interface for registration
 * and authentication as required by Part 1 specifications (no GUI / no JOptionPane).
 *
 * References:
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Prompt for Password with complexity validation loop
        String password;
        while (true) {
        ...
        // Prompt for South African Cell Phone Number with regex validation loop
        ...
        System.out.println("\n>>> You are now logged in. Thank you for using QuickChat! <<<");
        scanner.close();
    }
}
